A simple, responsive **Expense Tracker** web application built with **React + Vite**.  This app allows users to add, edit, delete, and filter transactions with a clean and mobile-friendly UI.
